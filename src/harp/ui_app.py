...
# Allow imports from src.harp when launched from repository root.
...
try:
    ...
    src_root = str(BASE_DIR.parent)
    if src_root not in sys.path:
        sys.path.insert(0, src_root)

    from harp.adaptive_trainer import train_with_adaptive_search
    from harp.data_generation import generate_data
    from harp.gpu_utils import GPUDetector
